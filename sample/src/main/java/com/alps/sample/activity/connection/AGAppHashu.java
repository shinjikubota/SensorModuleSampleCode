...
public class AGAppHashu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agapphashu);
    ...
    public void tsugi(View V){
        ...
        // 通知
        Toast.makeText(AGAppHashu.this, saibaidata.syousai, Toast.LENGTH_SHORT).show();
