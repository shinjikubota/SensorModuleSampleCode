...
public class boujyo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booujyo);
    ...
    public void onButton1(View v) {
        ...
        Intent intent = new Intent(getApplication(),bou1.class);
    ...
    public void onButton2(View v) {
        ...
        Intent intent = new Intent(getApplication(),bou2.class);
        startActivity(intent);
    ...
    public void onButton3(View v) {
        ...
        Intent intent = new Intent(getApplication(),bou3.class);
        startActivity(intent);
    ...
    public void onButton4(View v) {
        ...
        Intent intent = new Intent(getApplication(),bou4.class);
        startActivity(intent);
...
//    private String spinnerItems[] = {"農薬A", "農薬B", "農薬C", "農薬D"};
//
//
//    @Override
