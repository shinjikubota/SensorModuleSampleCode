...
public class hojyo extends AppCompatActivity {



    String url = "http://131.113.80.160/GETh.php";
    ListView listView;
...
//                        sb.append(array.getItem(i)+",");
                ...
                // 通知
                Toast.makeText(hojyo.this, sb.toString(), Toast.LENGTH_SHORT).show();


                //saibaidataに値を入れる。
                saibaidata.hojyo = sb.toString();



                //画面遷移
                Intent intent = new Intent(getApplication(), AGAppKakunin.class);
...
//    public void tohojyoA(View v) {
//
//        Intent intent = new Intent(getApplication(), AGApp.class);
//        startActivity(intent);
//
//        saibaidata.hojyo = "圃場A";
//
//    }
//
//
//
//    public void tohojyoB(View v) {
//
//        Intent intent = new Intent(getApplication(), AGApp.class);
//        startActivity(intent);
//
//        saibaidata.hojyo = "圃場B";
//    }
//
//
//    public void tohojyoC(View v) {
//
//        Intent intent = new Intent(getApplication(), AGApp.class);
//        startActivity(intent);
//
//        saibaidata.hojyo = "圃場C";
//    }
//
//
