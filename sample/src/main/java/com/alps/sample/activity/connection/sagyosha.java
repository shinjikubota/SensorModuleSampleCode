...
public class sagyosha extends AppCompatActivity {



    String url = "http://131.113.80.160/GETsag.php";
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sagyosha);
        ...
        btn.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                for (int i=0; i<checked.size(); i++) {
                    ...
                    Log.d("checkkkkkkkkkkkkkkkkkkkkkkkkk", String.valueOf(checked.valueAt(i)));

                    Log.d("checkkkkkkkkkkkkkkkkkkkkkkkkk", String.valueOf(checked.size()));
...
//                        sb.append(array.getItem(i)+",");
                ...
                // 通知
                Toast.makeText(sagyosha.this, sb.toString(), Toast.LENGTH_SHORT).show();


                //saibaidataに値を入れる。
                saibaidata.sagyousya = sb.toString();
...
//    public void tosagyoshaA(View v) {
//
//        Intent intent = new Intent(getApplication(), hojyo.class);
//        startActivity(intent);
//
//        saibaidata.sagyousya = "作業者A";
//    }
//
//
//
//    public void tosagyoshaB(View v) {
//
//        Intent intent = new Intent(getApplication(), hojyo.class);
//        startActivity(intent);
//
//        saibaidata.sagyousya = "作業者B";
//    }
//
//
//    public void tosagyoshaC(View v) {
//
//        Intent intent = new Intent(getApplication(), hojyo.class);
//        startActivity(intent);
//
//        saibaidata.sagyousya = "作業者C";
//    }
//
//
//
