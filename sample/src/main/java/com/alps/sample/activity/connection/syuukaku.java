...
public class syuukaku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syuukaku);
    ...
    public void onButton1(View v) {
        ...
        Intent intent = new Intent(getApplication(),syu1.class);
    ...
    public void onButton2(View v) {
        ...
        Intent intent = new Intent(getApplication(),syu2.class);
        startActivity(intent);
    ...
    public void onButton3(View v) {
        ...
        Intent intent = new Intent(getApplication(),syu3.class);
        startActivity(intent);
    ...
    public void onButton4(View v) {
        ...
        Intent intent = new Intent(getApplication(),syu4.class);
        startActivity(intent);
